...
Base.@kwdef mutable struct FUSEparameters__nb_unit{T} <: ParametersInit where {T<:Real}
    ...
    rho_0::Entry{T} = Entry{T}("-", "Desired radial location of the deposition profile"; default=0.0)
    width::Entry{T} = Entry{T}("-", "Desired width of the deposition profile"; default=0.3)
...
Base.@kwdef mutable struct FUSEparameters__ec_launcher{T} <: ParametersInit where {T<:Real}
    ...
    rho_0::Entry{T} = Entry{T}("-", "Desired radial location of the deposition profile"; default=0.5)
    width::Entry{T} = Entry{T}("-", "Desired width of the deposition profile"; default=0.025)
...
Base.@kwdef mutable struct FUSEparameters__ic_antenna{T} <: ParametersInit where {T<:Real}
    ...
    rho_0::Entry{T} = Entry{T}("-", "Desired radial location of the deposition profile"; default=0.0)
    width::Entry{T} = Entry{T}("-", "Desired width of the deposition profile"; default=0.1)
...
Base.@kwdef mutable struct FUSEparameters__lh_antenna{T} <: ParametersInit where {T<:Real}
    ...
    rho_0::Entry{T} = Entry{T}("-", "Desired radial location of the deposition profile"; default=0.8)
    width::Entry{T} = Entry{T}("-", "Desired width of the deposition profile"; default=0.05)
...
Base.@kwdef mutable struct FUSEparameters__pellets_launchers{T} <: ParametersInit where {T<:Real}
    ...
    rho_0::Entry{T} = Entry{T}("-", "Desired radial location of the deposition profile"; default=0.5)
    width::Entry{T} = Entry{T}("-", "Desired width of the deposition profile"; default=0.25)
