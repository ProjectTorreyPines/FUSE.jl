...
function ActorPedestal(dd::IMAS.dd, par::FUSEparameters__ActorPedestal, act::ParametersAllActors; kw...)
    ...
    par = par(kw...)
    eped_actor = ActorEPED(dd, act.ActorEPED; ne_from=par.ne_from, par.zeff_from, par.βn_from, par.ip_from, par.rho_nml, par.rho_ped)
    wped_actor = ActorWPED(dd, act.ActorWPED; ne_from=par.ne_from, par.zeff_from, par.rho_ped, par.do_plot)
