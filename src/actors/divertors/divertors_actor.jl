...
<<<<<<< Updated upstream
    ...
    #         boundary_plasma_model = BoundaryPlasmaModels.SOLBoundaryModel(par.boundary_model)
    #         push!(actor.boundary_plasma_models, boundary_plasma_model)
    #         BoundaryPlasmaModels.setup_model(boundary_plasma_model, target, eqt, cp1d,cs, sol1; par.impurities, par.impurities_fraction, par.heat_spread_factor,strike_index)
    #         boundary_plasma_model() # run
    #         if par.verbose
