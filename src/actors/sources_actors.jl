...
#  NBI  #
#= === =#
Base.@kwdef mutable struct ActorNBIsimple <: AbstractActor
    dd::IMAS.dd
    width::Vector{Real}
    rho_0::Vector{Real}
...
#  EC  #
#= == =#
Base.@kwdef mutable struct ActorECsimple <: AbstractActor
    dd::IMAS.dd
    width::Vector{Real}
    rho_0::Vector{Real}
    current_efficiency::Vector{Real}
...
#  IC  #
#= == =#
Base.@kwdef mutable struct ActorICsimple <: AbstractActor
    dd::IMAS.dd
    width::Vector{Real}
    rho_0::Vector{Real}
    current_efficiency::Vector{Real}
...
#  LH  #
#= == =#
Base.@kwdef mutable struct ActorLHsimple <: AbstractActor
    dd::IMAS.dd
    width::Vector{Real}
    rho_0::Vector{Real}
    current_efficiency::Vector{Real}
