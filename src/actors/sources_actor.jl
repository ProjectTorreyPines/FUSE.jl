...
function SimpleNBIactor(dd::IMAS.dd, act::ActorParameters; width::Real = 0.3, rho_0::Real = 0.0, current_efficiency::Real = 0.3)
...
function SimpleECactor(dd::IMAS.dd, act::ActorParameters; width::Real = 0.1, rho_0::Real = 0.0, current_efficiency::Real = 0.2)
...
function SimpleICactor(dd::IMAS.dd, act::ActorParameters; width::Real = 0.1, rho_0::Real = 0.0, current_efficiency::Real = 0.125)
...
function SimpleLHactor(dd::IMAS.dd, act::ActorParameters; width::Real = 0.15, rho_0::Real = 0.6, current_efficiency::Real = 0.4)
