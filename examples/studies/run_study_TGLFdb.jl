...
sty.database_folder = "/mnt/beegfs/users/neisert/ODSs/mastu_intersect_steady"   #d3d_negDcake_oak"#iri/166066"#mastu_curated_intersect"#d3d"#_negDcake_oak"
sty.save_folder = "/mnt/beegfs/users/neisert/ODSs/mastu_intersect_steady/outputs_quench_rho_0p1_0p05_0p75_rot"  #mastu_curated_intersect/outputs_rho_0p1_0p05_0p85_rot"
...
sty.custom_tglf_models = ["sat0quench_em_mastu_azf+1","sat0quench_es_mastu_azf+1","sat0quench_em_d3d_azf+1"]
...
sty
study = FUSE.StudyTGLFdb(sty, act; n_workers=60); # it is possible to pass in keyword arguments to sty
using Distributed
