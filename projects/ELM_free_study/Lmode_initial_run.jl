...
max_lh_power_threshold = IMAS.ConstraintFunction(:max_lh_power_threshold_fraction, "%", dd -> (L_H_threshold(dd) / dd.requirements.lh_power_threshold_fraction), <, 1.2)
